...
export default function LatihanSoalExtreme() {
  ...
  const [selectedOption, setSelectedOption] = useState<{ text: string; correct: boolean } | null>(null);
        ...
        <View style={styles.quizContainer}>
          ...
          {questions[currentQuestionIndex].answers.map((option, index) => (
            <TouchableOpacity
                ...
                onPress={() => handleOptionSelect(option)} // Berikan parameter opsi
            >
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoText}>Time Left: {timeLeft} seconds</Text>
          </View>
        </View>
      ) : (
        <View style={styles.quizContainer}>
          ...
          <Text style={styles.subtitle}>Klik Start game untuk memulai!</Text>
